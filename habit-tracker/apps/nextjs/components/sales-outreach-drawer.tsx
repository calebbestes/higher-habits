            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                <Chip
                  size="sm"
                  variant="flat"
                  className="border border-amber-200/80 bg-amber-50 text-[11px] font-semibold uppercase tracking-[0.18em] text-amber-800"
                >
                  Sales tracker
                </Chip>
          ...
          <div className="space-y-5 px-4 py-4 sm:px-6 sm:py-5">
            ...
            <Tabs
              ...
              onSelectionChange={(key) =>
                setActiveTab(key as "log" | "summary")
              }
              className="w-full"
              classNames={{
                base: "w-full",
                tabList:
                  "grid w-full grid-cols-2 rounded-2xl bg-slate-100/90 p-1",
                      ...
                      <CardBody className="gap-3 p-3 sm:p-4">
                        {daySales.map((activity) => {
                          const channel = SALES_CHANNEL_OPTIONS.find(
                            (option) => option.key === activity.channel,
                          );
