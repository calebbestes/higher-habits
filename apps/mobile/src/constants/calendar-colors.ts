...
export const CALENDAR_EVENT_COLORS = [
  ...
  { colorId: "3", label: "Tomato", color: "#D50000", foreground: "#FFFFFF" },
  { colorId: "4", label: "Tangerine", color: "#F4511E", foreground: "#FFFFFF" },
  { colorId: "5", label: "Pumpkin", color: "#EF6C00", foreground: "#FFFFFF" },
  { colorId: "6", label: "Mango", color: "#F09300", foreground: "#1D1D1D" },
  { colorId: "12", label: "Banana", color: "#F6BF26", foreground: "#1D1D1D" },
  { colorId: "11", label: "Citron", color: "#E4C441", foreground: "#1D1D1D" },
  { colorId: "10", label: "Avocado", color: "#C0CA33", foreground: "#1D1D1D" },
  { colorId: "9", label: "Pistachio", color: "#7CB342", foreground: "#1D1D1D" },
  { colorId: "8", label: "Basil", color: "#0B8043", foreground: "#FFFFFF" },
  { colorId: "13", label: "Sage", color: "#33B679", foreground: "#1D1D1D" },
  {
    colorId: "7",
    label: "Eucalyptus",
    color: "#009688",
  ...
  { colorId: "14", label: "Peacock", color: "#039BE5", foreground: "#FFFFFF" },
  { colorId: "15", label: "Cobalt", color: "#4285F4", foreground: "#FFFFFF" },
  {
    colorId: "16",
    label: "Blueberry",
    color: "#3F51B5",
  ...
  { colorId: "17", label: "Lavender", color: "#7986CB", foreground: "#FFFFFF" },
  { colorId: "18", label: "Wisteria", color: "#B39DDB", foreground: "#1D1D1D" },
  { colorId: "23", label: "Grape", color: "#8E24AA", foreground: "#FFFFFF" },
  { colorId: "24", label: "Amethyst", color: "#9E69AF", foreground: "#FFFFFF" },
  { colorId: "1", label: "Cocoa", color: "#795548", foreground: "#FFFFFF" },
  { colorId: "20", label: "Birch", color: "#A79B8E", foreground: "#1D1D1D" },
  { colorId: "19", label: "Graphite", color: "#616161", foreground: "#FFFFFF" },
] as const;
