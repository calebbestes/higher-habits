...
export function PlanNoteEditorModal({
  dateLabel,
  initialValue,
  noteType,
  onClose,
  ...
  const editorStyle = useMemo(
    () => ({
      ...
      contentCSSText: `
        body { font-size: 16px; line-height: 1.55; padding: 14px; }
        p, h1, ul, ol, blockquote { margin: 0 0 0.7em; }
        h1 { font-size: 18px; line-height: 1.4; }
        ul, ol { padding-left: 1.4em; }
        blockquote { border-left: 3px solid ${theme.tabBorder}; color: ${theme.textSecondary}; padding-left: 0.8em; }
      `,
    }),
    [
      theme.primary,
        ...
        >
          ...
          >
            <View>
              ...
              >
                Capture the thoughts you want to remember about this {noteType}.
              </Text>
            </View>
            <View
              style={[
...
const styles = StyleSheet.create({
  ...
  headerButton: { minWidth: 58, minHeight: 40, justifyContent: "center" },
  ...
  toolbar: { minHeight: 48, borderBottomWidth: StyleSheet.hairlineWidth },
