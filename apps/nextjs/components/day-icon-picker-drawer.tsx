...
export const DayIconPickerDrawer = ({
  ...
  const getMonthlyProgress = (
    ...
    for (const [entryDateKey, selection] of Object.entries(selectedIconsByDate)) {
    ...
    return { completedCount, plannedCount, targetCount, completedFraction, plannedFraction };
  };
            ...
            >
              <CardBody className="grid gap-3 p-3 sm:grid-cols-2 sm:p-4">
                {CUSTOM_DAY_ICON_OPTIONS.map((option) => {
                  ...
                  const { completedCount, targetCount, completedFraction, plannedFraction } =
                          ...
                          <div className="flex h-2 overflow-hidden rounded-full bg-slate-200/80">
                            ...
                            <div
                              ...
                              style={{
                                ...
                                backgroundImage: `repeating-linear-gradient(45deg, ${isSelected ? "#0ea5e9" : "#94a3b8"} 0px, ${isSelected ? "#0ea5e9" : "#94a3b8"} 3px, transparent 3px, transparent 7px)`,
                              }}
                            />
                          </div>
                        </div>
